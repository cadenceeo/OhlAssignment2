...
$query = 'SELECT C.customerID, C.emailAddress, C.firstName, C.lastName, A.line1, A.city, A.state, A.zipCode, A.phone FROM addresses A 
INNER JOIN customers C 
ON C.customerID = A.customerID
GROUP BY C.customerID, C.emailAddress, C.emailAddress, C.firstName, C.lastName, A.line1, A.city, A.state, A.zipCode, A.phone;';// PUT YOUR SQL QUERY HERE
